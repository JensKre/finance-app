...
3. System displays a table below the upload control showing a preview of the 100 most recent transaction entries imported into the system.
...
- A table showing the 100 most recent imported budget transactions is displayed below the upload option.
